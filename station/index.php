...
$pageTitle = 'Dashboard - İstasyon Paneli';
...
?>
            ...
            <div class="content-grid">
                ...
                <div class="card"
                    style="border: 2px solid var(--primary); box-shadow: 0 4px 20px rgba(37, 99, 235, 0.1);">
                            ...
                            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 15px;">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="price-input-group">
                                        ...
                                        <input type="number" name="diesel_price" step="0.01" min="0" max="100"
                                ...
                                <!-- TIR Mazot -->
                                <div class="form-group">
                                    <label class="form-label" style="font-weight: 700; color: #dc2626;"><i
                                            class="fas fa-truck"></i> TIR ÖZEL</label>
                                    <div class="price-input-group">
                                        <span class="currency">₺</span>
